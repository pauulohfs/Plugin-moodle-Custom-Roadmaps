...
$string['view_roadmap'] = 'Visualizar Página';
$string['roadmap_name'] = 'Título da Página';
$string['roadmap_slug'] = 'Slug (URL Amigável)';
...
$string['image_manager'] = 'Área de Imagens';
$string['upload_image'] = 'Enviar Imagem';
$string['images_list'] = 'Imagens Existentes';
$string['no_images'] = 'Nenhuma imagem encontrada.';
$string['copy_url'] = 'Copiar URL';
$string['delete_image'] = 'Excluir Imagem';
$string['confirm_delete_image'] = 'Tem certeza que deseja excluir esta imagem?';
$string['image_delete_success'] = 'Imagem excluída com sucesso.';
$string['image_upload_success'] = 'Imagem enviada com sucesso.';
$string['invalid_image'] = 'Arquivo de imagem inválido.';
